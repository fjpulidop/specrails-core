...
description: "sr:health-check — Run a comprehensive codebase health check: tests, linting, coverage, complexity, and dependency audit."
license: MIT
compatibility: "Requires npm (optional)."
metadata:
  author: specrails
  version: "1.0"
---
