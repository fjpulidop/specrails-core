...
16. **C1 aceptado en tres plataformas:** CI [36230546712](https://github.com/fjpulidop/specrails-core/actions/runs/36230546712), commit de merge probado `72323bf9d62dbf856cdc6d60471b8c0b2a0fe8a9`, head `e1e25589fb89660aaa9d80cd73980401050f0a54`, hash de fuentes `8df8b11980d708efa9d04349fcfd2788822ec1e5916f1f24ba8ef087cf2a7990`. macOS arm64, Linux x64 y Windows x64 pasan 200 cortes cada uno, paquete y ensamblado Desktop; medias put 0.282/0.721/4.164 ms. Windows demuestra owner SID actual y ACL protegida solo owner+SYSTEM. Elegir `node:sqlite`; C3 sube el mínimo a `>=22.22.3`, versión exacta probada, sin inferir aceptación de 22.13. C1 mantiene Node 20 en producción. `npm run ci` local completo pasó 998 tests y un skip preexistente con cobertura y paquete válidos. Esta decisión sustituye la provisionalidad del punto 15; no declara implementado el motor de producción.
