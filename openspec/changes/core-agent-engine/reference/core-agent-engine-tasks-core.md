...
**Evidencia C0, 2026-09-26:** implementado en [6ab6b3ce](https://github.com/fjpulidop/specrails-core/commit/6ab6b3ce2f26ee5f5d8f8055b9229322a65ad501), [PR #385](https://github.com/fjpulidop/specrails-core/pull/385). Se conserva la identidad auditada **workflow 7 / instrucciones 10**; las referencias 6/9 anteriores son históricas. Los dos fingerprints se capturaron antes de la extracción y se prueban con los descriptores reales. El contrato incluye `evaluate` y clasifica `help` mediante `cliPresentationOperations`. Suites afectadas: **144/144**, sin omisiones. `npm run ci` local (Node 22.22.3, macOS arm64): exit 0, **24/24** pruebas de scripts, **67 suites**, **1004 pruebas aprobadas y una omisión preexistente exclusiva de Windows**, cobertura sin rebajas y paquete verificado para los cuatro proveedores. La [matriz CI del commit](https://github.com/fjpulidop/specrails-core/actions/runs/36227847244) pasó **22 jobs** en Linux/macOS/Windows y Node 20/22/24, incluido el caso exclusivo de Windows. [Resultados completos y gate de publicación pendiente](../tasks.md#1-c0--contract-hygiene-and-frozen-legacy-fingerprint). No se publica una release automáticamente ni se da C1 por completado.
