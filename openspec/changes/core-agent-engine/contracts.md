...
- Aclarar y probar la transacción que une checkpoint y ledger al terminar un nodo, incluida la coordinación de ramas concurrentes. Ninguna prueba que escriba dos tablas en una transacción aislada sustituye la prueba sobre el ciclo real de LangGraph.
