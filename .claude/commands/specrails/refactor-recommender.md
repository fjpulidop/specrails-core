...
Scan the codebase for refactoring opportunities, score each by impact/effort ratio and VPC persona value, and optionally create GitHub Issues for the top findings in GitHub Issues.
...
---
_Generated by `/specrails:refactor-recommender` in specrails_
```
...
```
## Refactoring Opportunities — specrails
