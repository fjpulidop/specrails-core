...
- [chat_manager_patterns.md](chat_manager_patterns.md) — chat panel patterns: ChatManager vs QueueManager rationale, shared WS context, layout integration, command proposal detection, auto-title, migration 4
