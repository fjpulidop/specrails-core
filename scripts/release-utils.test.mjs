...
const packFiles = ['package.json', 'bin/specrails-core.mjs', 'dist/installer/cli.js', 'dist/pipeline/pipeline-state.js', 'integration-contract.json', 'pinned-versions.json', 'schemas/agent-runtime.schema.json', 'templates/commands/specrails/implement.md'].map((path) => ({ path }))
