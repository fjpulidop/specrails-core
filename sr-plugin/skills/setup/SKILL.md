...
# Generated by /sr:setup — edit this file to customize your workflow
...
---
*Edit this file to reflect your actual user persona. Run `/sr:product-backlog` to see how ideas align with this persona.*
```
...
- `/sr:implement` — full pipeline: architect → developer → reviewer
- `/sr:product-backlog` — view prioritized backlog
- `/sr:health-check` — run full codebase health check
- `/sr:opsx:ff` → `/sr:opsx:apply` → `/sr:opsx:archive` — OpenSpec workflow
...
Next steps:
  ...
  3. Run /sr:product-backlog to see backlog ideas for your domain
  4. Run /sr:implement #1 to start implementing a GitHub Issue
  5. Run /sr:opsx:ff to fast-forward an OpenSpec change
```
