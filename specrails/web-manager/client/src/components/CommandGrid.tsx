...
export function CommandGrid({ commands, onOpenWizard }: CommandGridProps) {
  ...
  // Sort: implement first, then batch-implement, then rest alphabetically
  const sorted = [...commands].sort((a, b) => {
    if (a.slug === 'implement') return -1
    if (b.slug === 'implement') return 1
    if (a.slug === 'batch-implement') return -1
    if (b.slug === 'batch-implement') return 1
